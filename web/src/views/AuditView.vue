...
const actionLabels = {
  ...
  apple_email_auth: "验证 Apple 邮箱管理账户",
  apple_email_auth_verify: "验证 Apple 邮箱管理登录验证码",
  add_apple_email: "发送 Apple 邮箱验证码",
  add_apple_email_verify: "添加 Apple 电子邮箱",
  delete_apple_email: "删除 Apple 电子邮箱",
