...
- “转发设置”支持添加 Apple 账户电子邮箱并通过邮箱验证码确认，也可删除备用邮箱；仅剩一个可转发邮箱时禁止删除。操作成功后自动刷新转发列表，首次管理邮箱时可能需要单独验证 Apple 账户。接口与验证流程见 [Apple 账户电子邮箱管理](docs/apple-account-email-protocol.md)。
