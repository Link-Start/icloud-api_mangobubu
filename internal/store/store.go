...
var (
	...
	ErrMailGroupNameRequired    = errors.New("mail group name is required")
	ErrMailGroupNameTooLong     = errors.New("mail group name is too long")
	ErrMailGroupNameExists      = errors.New("mail group name already exists")
	ErrMailGroupNotFound        = errors.New("mail group not found")
