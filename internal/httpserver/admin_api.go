...
func (s *Server) registerAdminAPIRoutes(api *gin.RouterGroup) {
	...
	protected.GET("/accounts/:id/forwarding/emails", s.adminAPIAccountEmail("list_apple_emails"))
	protected.POST("/accounts/:id/forwarding/email-auth", s.adminAPIAccountEmail("apple_email_auth"))
	protected.POST("/accounts/:id/forwarding/email-auth/verify", s.adminAPIAccountEmail("apple_email_auth_verify"))
	protected.POST("/accounts/:id/forwarding/emails", s.adminAPIAccountEmail("add_apple_email"))
	protected.POST("/accounts/:id/forwarding/emails/verify", s.adminAPIAccountEmail("add_apple_email_verify"))
	protected.DELETE("/accounts/:id/forwarding/emails", s.adminAPIAccountEmail("delete_apple_email"))
	...
	protected.POST("/aliases/batch/jobs/clear-completed", s.adminAPIClearCompletedAliasDeletionJobs)
