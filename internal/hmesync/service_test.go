...
func TestCreateAutoAliasAcceptsMinimalReserveResponseAfterPreflight(t *testing.T) {
	...
	wantProgress := []domain.AliasCreationProgressUpdate{
		...
		{Phase: domain.AliasCreationPhaseLoadingSession, Percent: 25, Kind: domain.AliasCreationKindNew},
		{Phase: domain.AliasCreationPhaseValidatingSession, Percent: 35, Kind: domain.AliasCreationKindNew},
		{Phase: domain.AliasCreationPhaseCheckingForwarding, Percent: 45, Kind: domain.AliasCreationKindNew},
		{Phase: domain.AliasCreationPhasePreparingKey, Percent: 55, Kind: domain.AliasCreationKindNew},
		{Phase: domain.AliasCreationPhaseReserving, Percent: 65, Kind: domain.AliasCreationKindNew},
		{Phase: domain.AliasCreationPhaseSavingCandidate, Percent: 75, Kind: domain.AliasCreationKindNew},
		{Phase: domain.AliasCreationPhaseReconciling, Percent: 85, Attempt: 1, Kind: domain.AliasCreationKindNew},
		{Phase: domain.AliasCreationPhaseConfirming, Percent: 85, Attempt: 1, Kind: domain.AliasCreationKindNew},
		{Phase: domain.AliasCreationPhaseSavingResult, Percent: 95, Attempt: 1, Kind: domain.AliasCreationKindNew},
		{Phase: domain.AliasCreationPhaseCompleted, Percent: 100, Kind: domain.AliasCreationKindNew},
	}
